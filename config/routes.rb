Rails.application.routes.draw do
  ...
  namespace :admin do # , module: 'admin' do             --When we want to route with a module and use that module's name as the URL prefix, we can use the namespace method instead of scope, module.
